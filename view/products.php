    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item"><a href="cart.php" class="nav-link">Cart <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill text-primary" id="cart_num" type="number"><?php echo $countProducts ?></span></a></li>
        </ul>
      </div>
    </div>
  </nav>
    ...
    <div class="text-center container py-5">
      ...
      <div class="row">
        ...
        if(isset($_GET['product_name'])){
           display_all_search_product($_GET['product_name']);
        }else{
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" href="" class="btn btn-outline-primary" data-dismiss="modal" onclick=" location.reload()">Ok</button>
        </div>
      </div>
    </div>
  </div>
    ...
    function add_to_cart(product_id) {
      ...
      xhttp.onload = function() {
        ...
        if (this.responseText == 1) {
          // let cart_item = Number(document.getElementById("cart_num").value);



          // cart_item = parseInt(cart_item) + 1;
          // alert(cart_item);
          // document.getElementById("cart_num").innerHTML = ""+cart_item;
